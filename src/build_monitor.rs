...
async fn run_build_inner(
    ...
    *slot.last_build_log.write().await = None;
    ...
    let guarded = GuardedCommand::new("cargo", Duration::from_secs(absolute_secs))
...
mod tests {
    ...
    use super::{
        ...
        merge_process_output, needs_frontend_prebuild, provenance_tree_root, rev_parse_head,
        should_self_heal_slot, stderr_submission_tail, update_lkg_after_success,
        verify_frontend_built, BuildPhase, BuildProvenance, BuildSource, BuildSourceKind,
        StderrClass, LAST_BUILD_STDERR_SUBMISSION_TAIL_BYTES,
    };
